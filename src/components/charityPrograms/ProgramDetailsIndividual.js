...
const ProgramDetailsIndividual = (props) => {
  ...
  useEffect(() => {
    dispatch(
      charityProgramActions.getProgramDetail({ programId: props?.programId })
    );
  }, []);
  ...
  if (programDetail) {
    charityFirstTwoChar = programDetail?.name?.slice(0, 2)?.toLowerCase();
  ...
  const initialValues = {
    ...
    charity: {
      charityName: programDetail?.name,
      id: programDetail?.id?.toString(),
        ...
        <div className="ant-col ant-col-24 mt-2">
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <h6 className="mb-3">by {selectedOrganization?.name}</h6>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-7 program-list detail-tab">
              <Tabs defaultActiveKey={"details"}>
                <TabPane tab={"Detail"} key={"details"}>
                  <div className="row mt-4 program-list">
                    <div className="col-md-12">
                      ...
                      <p className="mb-4">{programDetail?.description}</p>
                ...
                <TabPane tab={"Geography"} key={"geography"}>
                  <div className="row mt-4 program-list">
                    {programDetail?.geographyModel?.map?.((geography) => (
                      <div className="row mt-3 mb-4">
                        <div className="col-md-12">
                          <p>
                            <strong>City:</strong> {geography?.city}
                          </p>
                          <p>
                            <strong>State:</strong> {geography?.state}
                          </p>
                          <p>
                            <strong>District:</strong> {geography?.district}
                          </p>
                          <p>
                          ...
                          <p>
                            <strong>Latitude:</strong> {geography?.latitude}
                          </p>
                          <p>
                            <strong>Longitude:</strong> {geography?.longitude}
                          </p>
                        </div>
                      </div>
                    ))}
            ...
            <div className="col-md-5 mt-4 pl-0 pr-0" id="payment-section">
              ...
              <DonateHeader selectedCharity={programDetail} />
...
export default ProgramDetailsIndividual;
