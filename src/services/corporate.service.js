...
function getCorporates() {
    ...
    return fetch(`http://localhost:3000/corporates`, requestOptions).then(handleResponse);
}
...
function addCorporate(corporate) {
    ...
    return fetch(`http://localhost:3001/corporates/add`, requestOptions).then(handleResponse);
}
